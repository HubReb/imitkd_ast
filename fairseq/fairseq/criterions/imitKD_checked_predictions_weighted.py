...
@dataclass
class ImitKDConfigCheckedPredictionsWithGoldReferencesWeighted(FairseqDataclass):
    expert: str = field(
...
@register_criterion(
    "imit_kd_checked_predictions_weighted", dataclass=ImitKDConfigCheckedPredictionsWithGoldReferencesWeighted
)
