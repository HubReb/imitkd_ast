...
def calculate_ter_score_for_each_sentence_in_data(hypotheses: List[str], references: List[str], ast_dataset_filename: str, asr_refs: List[str], generated_hypos_asr: List[str]) -> List[
    ...
    :param ast_dataset_filename: name of csv containing AST dataset
    :param asr_refs: list of gold transcripts
    :param generated_hypos_asr: list of hypotheses generated by ASR model
...
def get_reference_and_hypothesis_strings_from_datafile(filename: str) -> Tuple[List[str], List[str]]:
    """
    Extract hypotheses and references from log file  of fairseq-generate

    :param filename:  name of log file
    :return: references: All references in log file in a list
    :return: hypotheses: All hypotheses in log file in a list
    """
...
def compare_ter_scores(
    ...
    """
    Extract 15 samples with the highest difference of TER scores of model 1 and TER scores model 2)
    :param ter_score_list_one: list of tuples of form (TER, hypothesis, reference, gold transcript, generated transcript)  for model 1
    :param ter_score_list_two: list of of same form as ter_score_list_one for model 2
    :param model1: name of the first model
    :param model2: name of the second model
    :return: string containing hypotheses, references, TER scores
    """
    comparisons = []
